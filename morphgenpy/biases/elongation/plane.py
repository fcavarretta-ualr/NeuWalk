...
def plane_boundary(reference_dendrite, origin, axis, K, n, strict=False):
  ...
  direction = reference_dendrite.points[-1] - origin
...
def plane_boundary_bias(rng, reference_dendrite, reference_direction, origin, axis, K, n, strict=False):
  return plane_boundary(reference_dendrite, origin, axis, K, n, strict=strict)
