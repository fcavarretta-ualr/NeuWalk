class Neurite:
    ...
    def __init__(self, section_type=None, parent=None, internal_root=False):
        """
        Parameters
        ----------
    ...
    def _connect(parent, child):
      if not (isinstance(parent, Neurite) and isinstance(child, Neurite)):
    ...
    def connect(self, neurite, relation="parent"):
        ...
        match relation:
          case "child":
            Neurite._connect(self, neurite)
          case "parent":
            Neurite._connect(neurite, self)
    ...
    def disconnect(self, neurite=None):
        ...
        # if it is a parent
        match Neurite._get_relation(self, neurite):
          case "child":
            Neurite._disconnect(self, neurite)
          case "parent":
            Neurite._disconnect(neurite, self)
    ...
    def root(self):
        ...
        return Neurite._root_and_depth(self)['parent']

      
    @property
    def depth(self):
        """Return the number of connections from this section to the root."""
        return Neurite._root_and_depth(self)['depth']
    ...
    def subtree(self):
        ...
        return Neurite._visit_tree(self)
