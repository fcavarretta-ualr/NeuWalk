...
m = generate(68)['output']
plot_morphology(m, section_colors={"basal_dendrite":"blue", "apical_dendrite":"red"})

print(sum(ch.total_length for ch in m.children if ch.label == "apical_dendrite"))
print(sum(ch.total_length for ch in m.children if ch.label == "basal_dendrite"))
