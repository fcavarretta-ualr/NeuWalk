...
python3 plot_neuron.py synthetic/OB/TUFTED/cell3.swc --ylim -1050 1050 --xlim -1050 1050 --zlim -1050 1050 --plot-2d yz --align-principal-axes --rotate-axis x --rotate-degree -90 --output ../../tufted-cell3-yz.png --hide-axes
...
python3 plot_neuron.py synthetic/OB/TUFTED/cell3.swc --ylim -1050 1050 --xlim -1050 1050 --zlim -1050 1050 --plot-2d xy --align-principal-axes --rotate-axis x --rotate-degree -90 --output ../../tufted-cell3-xy.png --hide-axes
...
python3 plot_neuron.py synthetic/aPC/PYR/cell25.swc --labels apical_dendrite basal_dendrite --plot-2d xz --align-principal-axes --zlim -400 650 --xlim -525 525 --hide-axes --output ../../apcpyr-cell25.png
...
python3 plot_neuron.py morphologies/aPC/SL/d080421a-100.CNG.swc --labels apical_dendrite --plot-2d xz --align-principal-axes --rotate-degrees -5 --rotate-axis y --zlim 0 400 --xlim -200 200 --hide-axes --output ../../sl-d080421a.png --linewidth 5
python3 plot_neuron.py synthetic/aPC/SL/cell0.swc --labels apical_dendrite --plot-2d xz --align-principal-axes --rotate-degrees 5 --rotate-axis y --zlim 0 400 --xlim -200 200 --hide-axes --output ../../sl-cell0.png --linewidth 5
