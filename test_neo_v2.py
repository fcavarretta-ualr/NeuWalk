...
def main():
    ...
    btop_layer = biases.get_elongation("plane_boundary", np.array([0., 0., 900.]), (np.pi, 0.), 10, -2)
    b = b1 + b2 + b3 + b4 
    ...
    elongation_bias = [ (0.25, b), (0.005, r), (0.2, biases.get_elongation("root_repulsion", 750.0, -2)), (0.1, btop_layer)  ]
    ...
    elongation_bias = [
      (0.2, biases.get_elongation("root_repulsion", 750, -2)),
      (0.005, r)
      ]
    # synthesize apical sections        
