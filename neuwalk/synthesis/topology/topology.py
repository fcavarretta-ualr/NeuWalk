...
from ...core.topology import SectionSynthesizer
...
class TopologySynthesizer:
    ...
    def initialize(self):
        ...
        Returns
        -------
        SectionSynthesizer or list of SectionSynthesizer
    ...
    def synthesize(self, max_steps=None, distance_limit=None):
        ...
        while active_sections:
            ...
            active_sections = self.rng.permute(next_active_sections)
            step += 1
