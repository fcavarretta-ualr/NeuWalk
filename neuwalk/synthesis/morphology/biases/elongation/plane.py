...
def plane_boundary(reference_section, reference_direction, origin, axis, K, n, strict=False, resistance=False):
  ...
  if resistance and np.dot(reference_direction, axis_direction) >= 0:
    return None
...
def plane_boundary_bias(rng, reference_section, reference_direction, origin, axis, K, n, strict=False, resistance=False):
  return plane_boundary(reference_section, reference_direction, origin, axis, K, n, strict=strict, resistance=resistance)
